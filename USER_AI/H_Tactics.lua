...
MyTact[1005]={TACT_ATTACK_L,SKILL_NEVER,KITE_NEVER,CAST_REACT,PUSH_NEVER,DEBUFF_NEVER,CLASS_BOTH,RESCUE_NEVER,-1,SNIPE_OK,KS_ALWAYS,0.5,CHASE_NORMAL} --Familiar
MyTact[1042]={TACT_ATTACK_M,-1,KITE_REACT,CAST_REACT,PUSH_NEVER,DEBUFF_NEVER,CLASS_OLD,RESCUE_NEVER,-1,SNIPE_OK,KS_ALWAYS,1,CHASE_NORMAL} --Steel Chonchon
...
MyTact[1095]={TACT_ATTACK_M,SKILL_NEVER,KITE_NEVER,CAST_REACT,PUSH_NEVER,DEBUFF_NEVER,CLASS_BOTH,RESCUE_NEVER,-1,SNIPE_OK,KS_ALWAYS,1,CHASE_NORMAL} --Andre
MyTact[1105]={TACT_ATTACK_M,SKILL_NEVER,KITE_NEVER,CAST_REACT,PUSH_NEVER,DEBUFF_NEVER,CLASS_BOTH,RESCUE_NEVER,-1,SNIPE_OK,KS_ALWAYS,1,CHASE_NORMAL} --Deniro
MyTact[1111]={TACT_SNIPE_M,SKILL_NEVER,KITE_ALWAYS,CAST_REACT,PUSH_NEVER,DEBUFF_NEVER,CLASS_OLD,RESCUE_NEVER,-1,SNIPE_OK,KS_ALWAYS,1,CHASE_NORMAL} --Drainliar
...
MyTact[1152]={TACT_SNIPE_M,-3,KITE_ALWAYS,CAST_REACT,PUSH_NEVER,DEBUFF_NEVER,CLASS_BOTH,RESCUE_NEVER,-1,SNIPE_OK,KS_ALWAYS,1,CHASE_NORMAL} --Orc Skeleton
MyTact[1153]={TACT_ATTACK_H,-3,KITE_ALWAYS,CAST_REACT,PUSH_NEVER,DEBUFF_NEVER,CLASS_BOTH,RESCUE_NEVER,-1,SNIPE_OK,KS_ALWAYS,1,CHASE_NORMAL} --Orc Zombie
MyTact[1160]={TACT_ATTACK_M,SKILL_NEVER,KITE_NEVER,CAST_REACT,PUSH_NEVER,DEBUFF_NEVER,CLASS_BOTH,RESCUE_NEVER,-1,SNIPE_OK,KS_ALWAYS,1,CHASE_NORMAL} --Pierre
...
TactLastSavedDate        = "20/07/2022 23:55:59"